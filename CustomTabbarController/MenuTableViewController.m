...
@interface MenuTableViewController ()<CustomTabbarDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    customCell.stepperStatusLabel.text = [NSString stringWithFormat:@"initial vc 1/%d", numberOfViewController.integerValue];
