...
@interface AppDelegate () <RSCustomTabbarDelegate>
{
    RSCustomTabbarController *tabbarController;
...
-(void)setCurrentCustomTabbarController:(RSCustomTabbarController*)tc
{
    tabbarController = tc;
}
